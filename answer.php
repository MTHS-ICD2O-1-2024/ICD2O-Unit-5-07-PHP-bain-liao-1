...
<head>
  <meta charset="utf-8" />
  <meta name="description" content="Sum of Numbers with Addition, in PHP" />
  ...
  <title>Sum of Numbers with Addition, in PHP</title>
</head>
  ...
  <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
    <header class="mdl-layout__header">
      <div class="mdl-layout__header-row">
        <span class="mdl-layout-title">Sum of Numbers with Addition, in PHP</span>
      </div>
    </header>
